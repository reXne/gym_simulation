...
def sample_environment(env_name='CartPole-v1', map_name="4x4", is_slippery=True, render=False):
    ...
    for _ in range(num_episodes):
        ...
        state_distribution[observation] = state_distribution.get(observation, 0) + 1
        ...
        while not done:
            ...
            state_action_key = (old_observation, action)
            state_action_distribution[state_action_key] = state_action_distribution.get(state_action_key, 0) + 1
    ...
    logging.info(f"State-Action Distribution: {state_action_distribution}")
...
def main():
    ...
    logging.basicConfig(level=logging.INFO,
                        ...
                        filename=f'./logs/01_sampling_tuples_{env_name}.log',  
