...
def compute_loss(outputs, outputs_next, targets):
    ...
    state_next_logits, _, _, decoder_logits, prior_dist, posterior_dist = outputs
    _, reward_logits, done_logits, _, _, _ = outputs_next
...
def main():
    ...
    model = SimulatorV2(state_dim=state_dim, action_dim=action_dim, latent_dim=latent_dim, hidden_dim=hidden_dim)
